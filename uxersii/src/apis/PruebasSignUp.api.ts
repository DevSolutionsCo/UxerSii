...
const pruebasAPI = axios.create({
  baseURL:
    "https://781hhnms-8000.usw3.devtunnels.ms/uxersiiPruebas/api/v1/signUp/",
});
...
export const updateUsuario = (id: number, { usuario }: UsuarioInterface) =>
  pruebasAPI.put(`/${id}/`, usuario);
