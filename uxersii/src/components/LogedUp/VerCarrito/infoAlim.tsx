...
function InfoAlim(props: Producto & { cantidadPorId?: number }) {
  return (
    <>
      <div className="flex flex-row sm:flex-row items-center my-5 mx-2">
        <div className="w-full sm:w-1/4 mx-auto mb-4 sm:mb-0 sm:ml-0 sm:mr-4 px-4">
