...
<html lang="es">
  ...
  <body>
    <!<!-- CONSULTA -->
    <% String apellidoP = null; String apellidoM = null; String nomb = null;
    String genero = null; String passw = null; String correo = null; String
    ubicacion = null; String contacto = null; String idORG = null; String Redes
    = null; String cpH =null; String fecha = null; String desc = null; int tipo
    = 0; String userH = (String) session.getAttribute("nombUserH"); String userO
    = (String) session.getAttribute("nombORG"); String userE = (String)
    session.getAttribute("nombEST"); if(userH != null){ apellidoP = (String)
    session.getAttribute("apellidoP"); apellidoM = (String)
    ...
    session.getAttribute("correoH"); fecha = (String)
    session.getAttribute("fechNac"); cpH = (String) session.getAttribute("CPH");
    if (session.getAttribute("desc_hog")==null) { desc = ""; }else{ desc =
    (String) session.getAttribute("desc_hog"); } tipo = 1; }else if(userE !=
    null){ nomb = (String) session.getAttribute("nombEST"); ubicacion = (String)
    ...
    session.getAttribute("tel_est"); Redes = (String)
    session.getAttribute("redesEST"); if
    (session.getAttribute("desc_est")==null) { desc = ""; }else{ desc = (String)
    session.getAttribute("desc_est"); } tipo = 2; } System.out.println(fecha);
    %>
      ...
      <div class="perfil-usuario-header">
        <div class="perfil-usuario-portada">
          <div class="perfil-usuario-avatar" id="avatarClick">
            <img
              src="https://static.vecteezy.com/system/resources/previews/020/911/746/non_2x/user-profile-icon-profile-avatar-user-icon-male-icon-face-icon-profile-icon-free-png.png"
              alt="img-avatar"
              id="selectedImage"
            />
