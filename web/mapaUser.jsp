<%@page import="corcho.mapa.puntosFijos.PuntoColecta"%>
...
<body>
    ...
    <div id="puntosColectaJson" style="display: none;">
        ${requestScope.puntosColectaJson}
    </div>
    
    <%
        // Obtén la lista de puntos desde el ámbito de solicitud
        List<PuntoColecta> puntos = (List<PuntoColecta>) request.getAttribute("puntosColecta");
    %>
...
<script>
    ...
    var centerCoordinates = { lat: 19.454162510024734, lng: -99.17519412458938 };
