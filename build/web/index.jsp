  ...
  <body>
    <header>
      <div class="TODOwriteNavbar">
        ...
        <div class="links">Que puedes hacer tu?</div>
    ...
    <section class="cardsillas_content">
      ...
      <div class="cardsillas_desp_content">
        <div class="cardsillas_desp">
          ...
          />
          <p>
     Uno de los primeros datos que encontramos dentro de las consecuencias de la p�rdida de alimentos es el volumen de agua desperdiciada para su producci�n. Hablamos de un total de 8.060 m�/s cada a�o. A esto se suman los 3.300 millones de toneladas de gases de efecto invernadero que se descargan a la atm�sfera del planeta durante el proceso, m�s los producidos con el vertido de los mismos.    </p>
        </div>
        <div class="cardsillas_desp">
          <img
          ...
          />
          <p>
        Seg�n la FAO, la Organizaci�n de las Naciones Unidas para la Alimentaci�n y la Agricultura, adem�s de estos impactos ambientales, estos desperdicios alimentarios suponen una p�rdida de m�s de 75.0000 millones de d�lares cada a�o.   </p>
        </div>
        <div class="cardsillas_desp">
          <img
