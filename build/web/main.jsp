            ...
            <div class="user-info">
                <div class="user-details">
                    ...
                    <% String apellidoP = null, apellidoM, nomb = null, genero, passw,
                        ...
                        String userA
                                = (String) session.getAttribute("nombre_admin");
                        String userE = (String) session.getAttribute("nombEST");
                        if (userH != null) {
                            apellidoP
                                    = (String) session.getAttribute("apellidoP");
                        ...
                        <div class="modal-contenido">
                            ...
                            <div class="card">
                                ...
                                <div class="content">
                                    ...
                                    <button class="btnn" onclick="cerrarsesion()">Cerrar sesion</button>
                                </div>
                            </div>
                        </div>
                    </div>
